    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      ...
      >
        ...
        <div className="flex-1 flex overflow-hidden">
          {/* Collections Sidebar */}
          <div className="w-64 border-r flex-shrink-0 bg-muted/30 flex flex-col">
                  ...
                  >
                    ...
                    <Button
                      ...
                      className={cn(
                        ...
                        selectedCollectionName === collection.name && "text-primary-foreground hover:text-primary-foreground hover:bg-primary/80"
                      )}
                      onClick={(e) => {
                        e.stopPropagation();
            ...
            {localCollection ? (
                  ...
                  <div className="p-4">
                    {localCollection.files.length === 0 ? (
                      <div className="flex flex-col items-center justify-center h-64 text-muted-foreground">
                        ...
                        <p>No backgrounds in this collection</p>
              ...
              <div className="flex-1 flex items-center justify-center text-muted-foreground">
                <div className="text-center">
                  ...
                  <p>Select a collection to manage</p>
        ...
        <Dialog open={showCreateDialog} onOpenChange={setShowCreateDialog}>
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new background collection. A folder will be created in the backgrounds directory.
              </DialogDescription>
            </DialogHeader>
            ...
            <AlertDialogHeader>
              ...
              <AlertDialogDescription>
                {deleteTarget?.type === 'collection' ? (
                  <>
                    Are you sure you want to delete the collection <strong>{deleteTarget.name}</strong>?
                    This will permanently delete all files in this collection. This action cannot be undone.
                  </>
                ) : (
                  <>
